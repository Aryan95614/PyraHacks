...
while True:
    ...
    if choices == 1:
        answer = int(input('Do you want to watch Shrek[1] or Tom and Jerry[2]'))
        if answer == 1:
    ...
    if choices == 2:
        answer = int(input('Do you want to watch Anabelle[1] or Scary Doll[2]'))
        if answer == 1:
    ...
    if choices == 3:
        answer = int(input('Do you want to watch Deep Water[1] or Memory[2]'))
        if answer == 1:
